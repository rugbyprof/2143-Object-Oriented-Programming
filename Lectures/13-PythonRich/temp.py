...
team_progress.add_task("[magenta]Thor", total=200)
team_progress.add_task("[cyan]Grax", total=400)

total = sum(task.total for task in job_progress.tasks)
overall_progress = Progress()
overall_task = overall_progress.add_task("All Jobs", total=int(total))

team1_progress = Progress()
team1_task = team1_progress.add_task("Team 1", total=int(total))
