...
int main() {
    ...
    std::string dsfolder = "../code/media/animations/dancing_skeleton";
    std::string drfolder = "../code/media/animations/dice_roll";
    ...
    if (!rickTexture.loadFromFile("./rick/rick.gif")) {  // Attempt to load the texture file
    ...
    // rickSprite.setTexture(rickTexture);  // Assign the loaded texture to the sprite
    // rickSprite.setPosition(0.f, 0.f);
    ...
    std::vector<std::string> rickFiles  = glob("./rick", pattern);
    std::vector<std::string> duaneFiles = glob("./duane", pattern);
    ...
    AnimatedSprite rickDance(rickFiles, 0.035f);
    AnimatedSprite duaneDance(duaneFiles, 0.035f);
    ...
    rickDance.setPosition(0, 0);
    rickDance.setScale(0.32, 0.32);
    duaneDance.setPosition(280, 0);
    ...
    while (window.isOpen()) {
        ...
        window.draw(rickDance);
        window.draw(duaneDance);
