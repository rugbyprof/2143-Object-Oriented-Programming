...
//     sf::RenderWindow window(sf::VideoMode(800, 600), "Animated Sprite with
//     Multiple Textures");
...
//     AnimatedSprite dancingSkeleton(dsfiles, 0.01f);  // Frame duration = 0.2
//     seconds AnimatedSprite diceRoll(drfiles, 0.2f);          // Frame
