...
"""
loads some list of 'size' with random vals
@params:
...
# The split function 'splits' the string on spaces (if no character is provided) and 
# returns a 'list' with all the individual words.
myList = myBook.split()
...
print(coord) # prints (12,14)
print(coord[0]) # prints 12
print(coord[1]) # prints 14

# This places coord[0] into x and coord[1] intro y
# This is how the dict loop from above works
x,y = coord
...
# prints just the values in the dict
print(d.values())

# Loop through dict and double each items value
for key,val in d.items():
  d[key] *= 2
 
# loop through dict and print out key,val pairs
for key,val in d.items():
  print(key,val)
